...
void main() {
    ...
    if (id > 99 && Color.a != 0.0) {
        ...
        switch (int(id)) {
            case 100:
                xOffset = int(guiSize.x * (-0.0/100))-57;
            ...
            case 101:
                ...
                break;
            case 102:
                xOffset = int(guiSize.x * (-0.0/100))-132;
                yOffset = int(guiSize.y * (100.0/100))-47;
                layer = 1;
                break;
            case 103:
                xOffset = int(guiSize.x * (-0.0/100))-132;
                ...
                break;
            case 104:
                xOffset = int(guiSize.x * (-0.0/100))-223;
                yOffset = int(guiSize.y * (100.0/100))-49;
                layer = 3;
                outlined = true;
                break;
            case 105:
            ...
            case 107:
                ...
                break;
            case 108:
                xOffset = int(guiSize.x * (-0.0/100))-308;
                yOffset = int(guiSize.y * (100.0/100))-41;
                layer = 3;
                outlined = true;
                break;
            case 109:
                xOffset = int(guiSize.x * (-0.0/100))-308;
                yOffset = int(guiSize.y * (100.0/100))-38;
                layer = 3;
                outlined = true;
                break;
            case 110:
                xOffset = int(guiSize.x * (-0.0/100))-200;
            ...
            case 111:
                ...
                break;
            case 112:
                xOffset = int(guiSize.x * (-0.0/100))-290;
            ...
            case 113:
                xOffset = int(guiSize.x * (-0.0/100))-290;
                yOffset = int(guiSize.y * (100.0/100))-27;
                layer = 3;
                outlined = true;
                break;
            case 114:
